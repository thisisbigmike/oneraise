...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems: { section: string; items: NavItem[] }[] = [
    { section: 'MAIN', items: [
      ...
      { name: 'Campaigns', path: '/dashboard/campaigns', badge: '3', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg> },
