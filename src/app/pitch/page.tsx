...
const SLIDES = [
  {
    id: "intro",
    eyebrow: "ONE RAISE",
    title: "Raising Together, Raising Better",
    description: "The future of giving isn't just about moving money; it's about moving trust. OneRaise is the world's first borderless trust protocol.",
  ...
  },
  {
    ...
    title: "Crowdfunding has a Transparency Problem",
    points: [
      {
        title: "The Black Hole",
        desc: "Donors often lose track of funds once they hit a campaign, with no way to verify real-world impact.",
      },
      {
        title: "Geographical Walls",
        desc: "Creators in emerging markets are excluded from global capital by legacy banking and strict requirements.",
      },
      {
        title: "All-or-Nothing Risk",
        desc: "Traditional platforms release funds upfront, leaving donors unprotected if a project fails or stalls.",
      },
    ],
    type: "list",
  },
  {
    ...
    title: "The Protect Protocol",
    description: "OneRaise holds funds in escrow and releases them only as milestones are verified. We bridge the gap between global capital and local impact.",
    ...
    points: [
      {
        ...
        desc: "Contributions are held securely until the project reaches its predefined phase.",
      },
      {
        title: "Proof of Progress",
        desc: "Creators submit verifiable evidence (photos, receipts, reports) to unlock the next funding tranche.",
      },
      {
        title: "Donor Certainty",
        desc: "If a milestone isn't met, funds can be returned or redirected, ensuring every dollar creates value.",
      },
    ],
    type: "list",
  },
  {
    ...
    title: "Powering the Global Social Impact Economy",
    stats: [
      { label: "Market Size", value: "$100B+", delta: "Social Giving" },
      { label: "Unbanked Reach", value: "1.4B", delta: "Potential" },
      { label: "Platform Fee", value: "5%", delta: "Sustainable" },
      { label: "Settlement", value: "Instant", delta: "Via Solana" },
    ],
    type: "stats",
  },
  {
    id: "ask",
    eyebrow: "THE VISION",
    title: "One Goal. One Platform. OneRaise.",
    description: "Join us in building a world where every dreamer has a path to reality and every donor has the certainty of impact.",
